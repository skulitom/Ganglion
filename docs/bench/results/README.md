...
| `halflife/` | The Half-Life pilot sessions: the first fights' ledger summary and screenshots, the ledger summary of the engagement with the motion channel fed live, and the flow percept's calibration against known turns | [HALFLIFE.md](../HALFLIFE.md) |
