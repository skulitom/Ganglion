...
| `halflife/` | The Half-Life pilot sessions: the first fights' ledger summary and screenshots, and the ledger summary of the engagement with the motion channel fed live | [HALFLIFE.md](../HALFLIFE.md) |
