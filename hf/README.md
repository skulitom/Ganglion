...
- Under supervision, v6 reaches its first shot in a live Half-Life fight as fast as the
  reference controller at the same step limit (0.99 against 0.97 s median over twenty trials,
  p 0.30) and with the lowest tracking error of the align steps of any condition
  (121 px against 159, p 0.005). It does not make the chain faster than the reference.
